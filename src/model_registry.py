...
def model_profitability_score(record: dict) -> float:
    ...
    strategy_return = (
        ...
        or _nested_get(metrics, ["backtest_oos", "trade_lifecycle", "metrics", "total_return"])
        or _nested_get(metrics, ["walk_forward", "trade_lifecycle", "metrics", "total_return"])
    ...
    sharpe = (
        _nested_get(metrics, ["backtest_oos", "trade_lifecycle", "metrics", "sharpe"])
        or _nested_get(metrics, ["walk_forward", "trade_lifecycle", "metrics", "sharpe"])
        or _nested_get(metrics, ["backtest_oos", "economic", "sharpe"])
        or _nested_get(metrics, ["walk_forward", "economic", "overall_sharpe"])
        or _nested_get(metrics, ["holdout", "economic", "sharpe"])
    )
    profit_factor = (
        _nested_get(metrics, ["backtest_oos", "trade_lifecycle", "metrics", "profit_factor"])
        or _nested_get(metrics, ["walk_forward", "trade_lifecycle", "metrics", "profit_factor"])
        or _nested_get(metrics, ["backtest_oos", "economic", "profit_factor"])
        or _nested_get(metrics, ["walk_forward", "economic", "overall_profit_factor"])
        or _nested_get(metrics, ["holdout", "economic", "profit_factor"])
    )
    drawdown = (
        _nested_get(metrics, ["backtest_oos", "trade_lifecycle", "metrics", "max_drawdown"])
        or _nested_get(metrics, ["walk_forward", "trade_lifecycle", "metrics", "max_drawdown"])
        or _nested_get(metrics, ["backtest_oos", "economic", "max_drawdown"])
        or _nested_get(metrics, ["walk_forward", "economic", "overall_max_drawdown"])
        or _nested_get(metrics, ["holdout", "economic", "max_drawdown"])
    )
    trades = (
        _nested_get(metrics, ["backtest_oos", "trade_lifecycle", "metrics", "trade_count"])
        or _nested_get(metrics, ["walk_forward", "trade_lifecycle", "metrics", "trade_count"])
        or _nested_get(metrics, ["backtest_oos", "economic", "trade_count"])
